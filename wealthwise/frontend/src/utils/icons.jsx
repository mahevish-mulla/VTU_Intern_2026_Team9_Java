export const Ico = {
  ...
  Calc: () => (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <path d="M5.5 4.5h5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M5.5 8h.01M8 8h.01M10.5 8h.01" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M5.5 11h.01M8 11h.01M10.5 11h.01" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
};
