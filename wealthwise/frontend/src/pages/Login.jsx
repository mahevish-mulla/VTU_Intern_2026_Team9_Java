...
export default function Login() {
  // If user is already logged in, skip login and send them to the dashboard
      ...
      <div className="auth__brand">
        ...
        <div className="auth__brand-body">
          ...
          <p className="auth__brand-sub">
            Track your mutual fund investments with live NAV updates in one organized dashboard
          </p>
        </div>
